document.getElementById('personalNuevo').addEventListener('keydown', function (e) {
  ...
  `;
    ...
    datos.forEach(dato => {
      ...
      <tr>
        ...
        <td>${dato.horas}</td>
        <td>
            <button class="btn btn-outline-info btn-sm" onClick="editarEstudiosCom(${dato.cont})" >
              <i class="fa fa-edit"></i>
            </button>
            <button class="btn btn-outline-danger btn-sm" onClick="anularEstudiosCom(${dato.cont})" >
              <i class="fa fa-trash"></i>
            </button>
    ...
    if (colegios != "") {
        ...
        datos.forEach(dato => {
          ...
          <tr>
            ...
            <td>
                <button class="btn btn-outline-info btn-sm" onClick="editarColegiatura(${dato.cont})" >
                  <i class="fa fa-edit"></i>
                </button>
                <button class="btn btn-outline-danger btn-sm" onClick="anularColegiatura(${dato.cont})" >
                  <i class="fa fa-trash"></i>
                </button>
    ...
    datos.forEach(dato => {
        tabla += `
          <tr>
            ...
            <td>${dato.nivel}</td>
            <td>
                <button class="btn btn-outline-info btn-sm" onClick="editarIdioma(${dato.cont})" >
                  <i class="fa fa-edit"></i>
                </button>
                <button class="btn btn-outline-danger btn-sm" onClick="anularIdioma(${dato.cont})" >
                  <i class="fa fa-trash"></i>
                </button>
...
function guardarExperiencia() {
    ...
    var archivo = document.getElementById('subidor-exp').value;
    var cont = 0;
  ...
  `;
    ...
    datos.forEach(dato => {
      ...
      <tr>
        ...
        <td>
            <button class="btn btn-outline-info btn-sm" onClick="editarExperiencia(${dato.cont})" >
              <i class="fa fa-edit"></i>
            </button>
            <button class="btn btn-outline-danger btn-sm" onClick="anularExperiencia(${dato.cont})" >
              <i class="fa fa-trash"></i>
            </button>
...
function guardarEstudios() {
    ...
    if (estudios != "") {
        if (id != "") {
            ...
            document.getElementById('doc-est').value = "";
            document.getElementById("mensaje").innerHTML = "";
        } else {
            var recuperado = JSON.parse(estudios); // Convertimos de vuelta a un objeto
            cont = recuperado[recuperado.length - 1].cont + 1;
    ...
    datos.forEach(dato => {
        tabla += `
            <tr>
              ...
              <td>
                    <button class="btn btn-outline-info btn-sm" onClick="editarEstudios(${dato.cont})" >
                        <i class="fa fa-edit"></i>
                    </button>
                    <button class="btn btn-outline-danger btn-sm" onClick="anularEstudios(${dato.cont})" >
                        <i class="fa fa-trash"></i>
                    </button>
              </td>
            </tr>
...
function anularEstudios(cont) {
    ...
    if (estudios) {
        var recuperado = JSON.parse(estudios);
        recuperado = recuperado.filter(dato => dato.cont !== cont);
        localStorage.setItem('estudios', JSON.stringify(recuperado));
        construirTablaEstudios(recuperado);
    } else {
    ...
    if (estudios != "") {
        ...
        recuperado = recuperado.map(obj => {
            if (obj.cont === cont) {
                ...
                document.getElementById('doc-est').value = obj.doc;
    ...
    if (licencias != "") {
        ...
        recuperado = recuperado.map(obj => {
            if (obj.cont === cont) {
                ...
                document.getElementById('meses-licencia').value = obj.dias;
                document.getElementById('agnos-licencia').value = obj.dias;
    ...
    if (permisos != "") {
        ...
        recuperado = recuperado.map(obj => {
            if (obj.cont === cont) {
                ...
                document.getElementById('meses-permiso').value = obj.dias;
                document.getElementById('agnos-permiso').value = obj.dias;
                ...
                if (obj.acuenta === 1) {
                    ...
                    inputPeriodo.value = obj.periodo; // opcional: cargar año actual
                }
                if (obj.archivo && obj.archivo.trim() !== '') {
                    document.getElementById("mensaje-per").innerHTML =
                        '<a href="../repositories/' + obj.archivo + '" class="text-success" target="_blank"><i class="fa fa-eye" ></i>Ver documento</a>';
