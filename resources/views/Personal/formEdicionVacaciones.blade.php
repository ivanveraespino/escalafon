    ...
    <div class="row">
        <div class="col-12 col-sm-6">
            <div class="form-floating">
                ...
                <label for="entidad">Periodo5<span class="required">*</span></label>
            </div>
            <div class="row">
                <div class="form-floating ">
                    <input type="text" name="tipodoc-vac" id="tipodoc-vac" class="form-control" list="datalisOptions">
            ...
            <div class="text-center">
                <a class="btn btn-outline-info ml-auto mr-0 " onclick="guardarVacaciones()"
                    style="margin-right: 10px;">Guardar Cambios</a>
            </div>
        </div>
                        ...
                        <div class="card m-1">
                            <table class="table">
                                ...
                                <tbody id="ll">
                                    ...
                                    <tr>
                                        <td class="p-0 {{$l->acuentavac == 1? 'bg-warning-subtle':''}}">
                        ...
                        <div class="card m-1">
                            <table class="table">
                                ...
                                <tbody id="lp">
                                    ...
                                    <tr>
                                        <td class=" p-0 {{$p->acuentavac == 1? 'bg-warning-subtle':''}}">
