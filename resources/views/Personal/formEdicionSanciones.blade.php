            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>
                            <a class="btn btn-outline-info btn-sm" onClick="editarSanciones({{ $cont }})">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a class="btn btn-outline-danger btn-sm" onClick="anularSanciones({{ $cont}})">
