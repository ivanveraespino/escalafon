                    ...
                    <input type="hidden" class="form-control" id="Edid" name="id"/>
                        <div class="form-row gap-3">
                            ...
                            <div class="form-floating" id="desde_vlp">
                                <input type="date" class="form-control" id="Edfecha_ini" name="fecha_ini" placeholder="Ejm. 232-2023" onchange="validar_vlp(validacion)" >
                                <label for="entidad" class="required"><span class="required">*</span>Desde</label>
                            </div>  
                            <div class="form-floating" id="hasta_vlp">
                                <input type="date" class="form-control" id="Edfecha_fin" name="fecha_fin" placeholder="Ejm. 232-2023" onchange="validar_vlp(validacion)" >
