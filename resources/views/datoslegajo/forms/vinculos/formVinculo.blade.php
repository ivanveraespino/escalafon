...
<div class="col-6 col-lg-3">
    <div class="form-floating  pb-1">
        <input type="text" class="form-control" list="datalistOptions" name="tipodoc-vin" id="tipodoc-vin" required>
    ...
    <div class="form-floating pb-1">
        <input type="text" class="form-control" id="nrodoc-vin" name="nrodoc-vin" required>
...
<div class="col-6 col-lg-3">
    <div class="form-floating pb-1">
        <input type="date" class="form-control" id="fecha-ini-vin" name="fecha-ini-vin" required>
