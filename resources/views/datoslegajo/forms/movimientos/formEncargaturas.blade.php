...
<div class="row">
    <div class="col-sm-6 div-12">
        <div class="container pb-2 pl-0 pr-0">
            <div class="row">
                <div class="form-group col-12">
                    <label for="unidad-encargada">Unidad Organica<span class="required">*</span></label>
                ...
                <div class="form-group col-12">
                    ...
                    <textarea name="descripcion-encargo" id="descripcion-encargo" class="form-control">
        ...
        <div class="row border boder-1 p-1">
