...
"id"=> $compensacion->id,
"cambio" => 0,
"tipocom" => $compensacion->tipo_compensacion,
...
@endphp
<input type="hidden" name="compensaciones" id="compensaciones">
<input type="hidden" name="id-compensacion" id="id-compensacion">
<div class="row">
